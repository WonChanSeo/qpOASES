// Generated by gencpp from file tocabi_msgs/TaskCommand.msg
// DO NOT EDIT!


#ifndef TOCABI_MSGS_MESSAGE_TASKCOMMAND_H
#define TOCABI_MSGS_MESSAGE_TASKCOMMAND_H
...
struct TaskCommand_
{
  ...
  _contactredis_type contactredis;
   ...
   typedef uint8_t _maintain_lc_type;
  _maintain_lc_type maintain_lc;
  ...
  _right_foot_type right_foot;
   ...
   typedef uint8_t _left_hand_type;
  _left_hand_type left_hand;

   typedef uint8_t _right_hand_type;
  ...
  _pattern2_type pattern2;
   ...
   typedef uint32_t _comcontrol_type;
  _comcontrol_type comcontrol;
  ...
  _imu_type imu;
   ...
   typedef uint8_t _mom_type;
  _mom_type mom;

   typedef uint8_t _MPC_type;
  _MPC_type MPC;
  ...
  typedef boost::shared_ptr< ::tocabi_msgs::TaskCommand_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::tocabi_msgs::TaskCommand_<ContainerAllocator> const> ConstPtr;

}; // struct TaskCommand_

typedef ::tocabi_msgs::TaskCommand_<std::allocator<void> > TaskCommand;

typedef boost::shared_ptr< ::tocabi_msgs::TaskCommand > TaskCommandPtr;
typedef boost::shared_ptr< ::tocabi_msgs::TaskCommand const> TaskCommandConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::tocabi_msgs::TaskCommand_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::tocabi_msgs::TaskCommand_<ContainerAllocator> >::stream(s, "", v);
return s;
}


template<typename ContainerAllocator1, typename ContainerAllocator2>
bool operator==(const ::tocabi_msgs::TaskCommand_<ContainerAllocator1> & lhs, const ::tocabi_msgs::TaskCommand_<ContainerAllocator2> & rhs)
{
  return lhs.ratio == rhs.ratio &&
    ...
    lhs.maintain_lc == rhs.maintain_lc &&
    lhs.left == rhs.left &&
    lhs.right == rhs.right &&
...
template <class ContainerAllocator>
struct IsMessage< ::tocabi_msgs::TaskCommand_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::tocabi_msgs::TaskCommand_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::tocabi_msgs::TaskCommand_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::tocabi_msgs::TaskCommand_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::tocabi_msgs::TaskCommand_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::tocabi_msgs::TaskCommand_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::tocabi_msgs::TaskCommand_<ContainerAllocator> >
{
  ...
  static const char* value(const ::tocabi_msgs::TaskCommand_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4d5a7e8dd06d9058ULL;
  static const uint64_t static_value2 = 0xde4cc52d3297774cULL;
};

template<class ContainerAllocator>
struct DataType< ::tocabi_msgs::TaskCommand_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::tocabi_msgs::TaskCommand_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::tocabi_msgs::TaskCommand_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::tocabi_msgs::TaskCommand_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::tocabi_msgs::TaskCommand_<ContainerAllocator>& v)
  {
    s << indent << "ratio: ";
    ...
    s << indent << "maintain_lc: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.maintain_lc);
    s << indent << "left: ";
    ...
    s << indent << "left_hand: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.left_hand);
    s << indent << "right_hand: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.right_hand);
    s << indent << "time: ";
    ...
    s << indent << "comcontrol: ";
    Printer<uint32_t>::stream(s, indent + "  ", v.comcontrol);
    s << indent << "ik_mode: ";
    ...
    s << indent << "mom: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.mom);
    s << indent << "MPC: ";
    Printer<uint8_t>::stream(s, indent + "  ", v.MPC);
...
#endif // TOCABI_MSGS_MESSAGE_TASKCOMMAND_H
